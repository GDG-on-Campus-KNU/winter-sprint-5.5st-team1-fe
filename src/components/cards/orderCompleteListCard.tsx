...
export function OrderCompleteListCard({ order }: OrderCompleteListCardProps) {
    return (
        <Card className="w-full max-w-4xl p-6 border border-gray-100 shadow-sm bg-white rounded-xl text-left">
            <div className="flex flex-col gap-5">
                
                <div className="flex justify-between items-center">
                    <div className="text-[24px] font-medium sm:text-[22px]">
                        <span className="text-black">주문번호: </span>
                        <span className="text-pink-500">{order.orderNumber}</span>
                    </div>
                </div>
                
                <div className="text-[20px] font-normal text-gray-500 leading-tight sm:text-[18px]">
                ...
                <div className="pt-4 border-t border-gray-100 space-y-3">
                    ...
                    <div className="flex text-[20px] font-regular text-gray-400 sm:text-[18px]">
                    ...
                    <div className="flex justify-between items-end pt-2">
                        <div className="flex items-baseline text-[20px] font-semibold text-gray-500 sm:text-[18px]">
                            <span className="w-24 shrink-0">총 금액</span>
                            <span className="text-[24px] sm:text-[22px]">
